...
//  private static final String TF_OD_API_LABELS_FILE = "file:///android_asset/labelmap.txt";
    ...
    private static final int TF_OD_API_INPUT_SIZE = 300;
    private static final boolean TF_OD_API_IS_QUANTIZED = true;
    private static final String TF_OD_API_MODEL_FILE = "resykler.tflite";
    private static final String TF_OD_API_LABELS_FILE = "file:///android_asset/resykler.txt";
...
//                                }
//                            } else {
//                                final long sTime = SystemClock.uptimeMillis();
//                                uploadImage();
//                                SystemClock.sleep(100);
//                                downloadText();
//                                long eTime = SystemClock.uptimeMillis() - sTime;
//                                LOGGER.i("이 동 시 간: " + eTime);
//                                ImageUtils.saveBitmap(bmap, mFormat.format(mDate).toString());
//                            }
//                        }
                        trackingOverlay.postInvalidate();
