...
//        img_title.serVisibility(View.GONE);
...
//        Img_title.setText("");
    ...
    public void downloadText() {
        ...
        Call<String> call = apiInterfaceText.downloadText(rtext);
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onFailure(Call<String> call, Throwable t) {
                Log.d("http", "noway~~~~~~~~~~~~~~~ Throwable " + t.toString());
            }
...
//      SystemClock.sleep(500);
    ...
    public String showText() {
        ...
        Random r = new Random();
        try {
            String texts = readFromAssets("addWords.txt");
            words = texts.split("\n");
            String word = words[r.nextInt(31)];
            for (int i = 0; i < 3; i++) {
